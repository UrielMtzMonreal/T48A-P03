...
Original file is located at
    https://colab.research.google.com/drive/1Q12xBFwB4NriNhWeEOaByk4X5sro_9nw
"""
...
# Histograma (requiere matplotlib)
import matplotlib.pyplot as plt
plt.hist(altura, bins=10)  # bins define el número de barras en el histograma
plt.xlabel("Valor")
plt.ylabel("Frecuencia")
plt.title("Histograma de los datos")
plt.show()
...
# Histograma (requiere matplotlib)
import matplotlib.pyplot as plt
plt.hist(cintura, bins=10)  # bins define el número de barras en el histograma
plt.xlabel("Valor")
plt.ylabel("Frecuencia")
plt.title("Histograma de los datos")
plt.show()
